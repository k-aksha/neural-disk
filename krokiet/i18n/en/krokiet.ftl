...
rust_init_error_message =
    ...
    This may be caused by missing or malfunctioning OpenGL/Vulkan drivers, running the application in a virtual machine or a bug in NeuralDisk or one of its libraries.
...
main_window_title = NeuralDisk - Data Cleaner
...
other_apps_video_thumbnailer_desc = Wrapper around the video thumbnail generator used in NeuralDisk.
...
directories_view_button_text = Directories
errors_view_button_text = Errors
ref = Ref
path = Path
...
sidebar_collapse_text = Collapse
sidebar_expand_text = Expand
...
settings_copilot_enabled_text = Enable AI copilot (requires a local Ollama server)
settings_copilot_ollama_base_url_text = Ollama server URL
settings_copilot_ollama_model_text = Ollama model name
copilot_button_text = Copilot
agent_chat_popup_title_text = Copilot
agent_chat_input_placeholder_text = Ask the copilot to find and clean up files...
agent_chat_send_button_text = Send
