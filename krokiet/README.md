...
The easiest way is to compile newest NeuralDisk, is to run
```
cargo install neuraldisk --locked
```

which will install, the latest and optimized version of NeuralDisk.
...
If you have installed new `cargo`, you can easily compile and install it via `cargo install neuraldisk`
...
This app is now branded NeuralDisk. It was originally named Krokiet - here's the story of that name:
