...
use neuraldisk_core::common::items::{DEFAULT_EXCLUDED_DIRECTORIES, DEFAULT_EXCLUDED_ITEMS};
...
use neuraldisk_core::tools::big_file::SearchMode;
...
use neuraldisk_core::tools::temporary::DEFAULT_TEMP_EXTENSIONS_STR;
use neuraldisk_core::tools::video_optimizer::{NoiseReductionMethod, VideoCodec, VideoCroppingMechanism, VideoOptimizerMode};
use home::home_dir;
...
pub struct BasicSettings {
    ...
    #[serde(default = "default_agent_chat_panel_width")]
    pub agent_chat_panel_width: f32,
    #[serde(default = "ttrue")]
    ...
    #[serde(default)]
    pub agent_copilot_enabled: bool,
    #[serde(default = "default_agent_ollama_base_url")]
    pub agent_ollama_base_url: String,
    #[serde(default = "default_agent_ollama_model")]
    pub agent_ollama_model: String,
...
pub(crate) fn default_agent_ollama_base_url() -> String {
    "http://localhost:11434".to_string()
}
pub(crate) fn default_agent_ollama_model() -> String {
    "llama3.1".to_string()
}
pub(crate) fn default_preview_panel_width() -> f32 {
    400.0
}
pub(crate) fn default_agent_chat_panel_width() -> f32 {
    300.0
}
