# neuraldisk_core – Architecture Guide

## Overview

`neuraldisk_core` is the shared scanning engine used by all frontends. It has no UI
...
exception in this workspace: `neuraldisk_core` is a library every frontend depends on, and external
