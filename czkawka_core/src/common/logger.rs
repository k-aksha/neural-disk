...
pub fn filtering_messages(record: &Record) -> bool {
    if let Some(module_path) = record.module_path() {
        ...
        // if !["neuraldisk", "log_panics", "smithay_client_toolkit", "sctk_adwaita"]
        //     .iter()
        ...
        // "neuraldisk" covers all renamed crates: neuraldisk, neuraldisk_core, neuraldisk_cli, neuraldisk_gui
        ["neuraldisk", "log_panics", "cedinia"].iter().any(|t| module_path.starts_with(t))
    } else {
        true
    }
}
