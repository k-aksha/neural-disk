...
use neuraldisk_core::tools::bad_names;
use neuraldisk_core::tools::bad_names::{BadNameEntry, BadNames, BadNamesParameters};
use rayon::prelude::*;
...
pub(crate) fn scan_bad_names(a: Weak<MainWindow>, sd: ScanData) {
    thread::Builder::new()
        ...
        .spawn(move || {
            let checked_issues = neuraldisk_core::tools::bad_names::NameIssues {
