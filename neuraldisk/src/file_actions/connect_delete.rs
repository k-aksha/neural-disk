...
fn remove_single_item(full_path: &str, is_folder_tab: bool, remove_to_trash: bool) -> Result<(), String> {
    if is_folder_tab {
        return neuraldisk_core::common::remove_folder_if_contains_only_empty_folders(full_path, remove_to_trash);
    }
    neuraldisk_core::common::remove_single_file(full_path, remove_to_trash)
}
