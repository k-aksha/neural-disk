...
use neuraldisk_core::tools::video_optimizer::{HardwareEncoder, NoiseReductionMethod, VideoCodec, VideoCropSingleFixParams, VideoCroppingMechanism, VideoTranscodeFixParams};
...
fn optimize_single_video(stop_flag: &Arc<AtomicBool>, video_path: &str, original_size: u64, transcode_params: &VideoTranscodeFixParams) -> Result<(), String> {
    neuraldisk_core::tools::video_optimizer::core::process_video(stop_flag, video_path, original_size, transcode_params)
}
...
fn crop_single_video(stop_flag: &Arc<AtomicBool>, full_path: &str, _original_size: u64, params: VideoCropSingleFixParams, codec: &str) -> Result<(), String> {
    neuraldisk_core::tools::video_optimizer::core::fix_video_crop(std::path::Path::new(full_path), &params, stop_flag, codec)
}
