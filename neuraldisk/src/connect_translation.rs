use neuraldisk_core::TOOLS_NUMBER;
use neuraldisk_core::localizer_core::LANGUAGE_LIST;
...
pub fn find_the_closest_language_idx_to_system() -> usize {
    ...
    if let Some(language) = requested_languages.first() {
        ...
        return neuraldisk_core::localizer_core::find_language_idx(&tag);
    }
    0
}
...
pub(crate) fn change_language(app: &MainWindow) {
    let localizers = vec![
        ...
        ("neuraldisk", localizer_krokiet::localizer_krokiet()),
    ];
...
fn translate_items(app: &MainWindow) {
    ...
    translation.set_directories_view_button_text(flk!("directories_view_button_text").into());
    translation.set_errors_view_button_text(flk!("errors_view_button_text").into());
    ...
    translation.set_sidebar_collapse_text(flk!("sidebar_collapse_text").into());
    translation.set_sidebar_expand_text(flk!("sidebar_expand_text").into());
    ...
    translation.set_settings_copilot_enabled_text(flk!("settings_copilot_enabled_text").into());
    translation.set_settings_copilot_ollama_base_url_text(flk!("settings_copilot_ollama_base_url_text").into());
    translation.set_settings_copilot_ollama_model_text(flk!("settings_copilot_ollama_model_text").into());
    translation.set_copilot_button_text(flk!("copilot_button_text").into());
    translation.set_agent_chat_popup_title_text(flk!("agent_chat_popup_title_text").into());
    translation.set_agent_chat_input_placeholder_text(flk!("agent_chat_input_placeholder_text").into());
    translation.set_agent_chat_send_button_text(flk!("agent_chat_send_button_text").into());
