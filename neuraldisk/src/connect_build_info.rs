use neuraldisk_core::common::build_runtime_info::BuildRuntimeInfo;
use neuraldisk_core::common::consts::{HEIC_EXTENSIONS, RAW_IMAGE_EXTENSIONS};
use neuraldisk_core::common::image::get_dynamic_image_from_path;
use rfd::FileDialog;
        ...
        std::thread::spawn(move || {
            ...
            weak2
                .upgrade_in_event_loop(move |app| {
                    ...
                    gs.set_build_info_diagnostic_text(info.format_diagnostic_text("NeuralDisk").into());
