...
use neuraldisk_core::common::basic_gui_cli::CliResult;
use neuraldisk_core::common::config_cache_path::get_config_cache_path;
use neuraldisk_core::common::{get_all_available_threads, set_number_of_threads};
...
pub(crate) fn set_base_settings_to_gui(app: &MainWindow, basic_settings: &BasicSettings, preset_idx: i32) {
    ...
    settings.set_sidebar_expanded(basic_settings.sidebar_expanded);
    settings.set_preview_panel_width(basic_settings.preview_panel_width);
    settings.set_agent_chat_panel_width(basic_settings.agent_chat_panel_width);
    ...
    settings.set_agent_copilot_enabled(basic_settings.agent_copilot_enabled);
    settings.set_agent_ollama_base_url(basic_settings.agent_ollama_base_url.clone().into());
    settings.set_agent_ollama_model(basic_settings.agent_ollama_model.clone().into());
...
pub(crate) fn collect_base_settings(app: &MainWindow) -> BasicSettings {
    ...
    let sidebar_expanded = settings.get_sidebar_expanded();
    let preview_panel_width = settings.get_preview_panel_width();
    let agent_chat_panel_width = settings.get_agent_chat_panel_width();
    ...
    let agent_copilot_enabled = settings.get_agent_copilot_enabled();
    let agent_ollama_base_url = settings.get_agent_ollama_base_url().to_string();
    let agent_ollama_model = settings.get_agent_ollama_model().to_string();
    BasicSettings {
        language,
        default_preset,
        preset_names,
