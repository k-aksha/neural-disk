...
use neuraldisk_core::common::logger::setup_logger;
use neuraldisk_core::common::logger::{filtering_messages, print_version_mode};
...
fn setup_android_logger() {
    ...
    let file = neuraldisk_core::common::config_cache_path::get_config_cache_path().and_then(|p| {
