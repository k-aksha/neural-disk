...
use neuraldisk_core::common::image::{ImgResizeOptions, LoadedImage, get_dynamic_image_from_path};
...
pub fn thumbnail_cache_dir() -> PathBuf {
    ...
    {
        let base = crate::android_cache_path().unwrap_or("/data/data/io.neuraldisk.cedinia/cache");
