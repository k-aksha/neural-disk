...
use neuraldisk_core::tools::similar_images::{GeometricInvariance, SimilarityPreset};
    ...
    match tool {
        ...
        ActiveTool::TemporaryFiles => {
            ...
            let extensions = if extensions.is_empty() {
                neuraldisk_core::tools::temporary::TEMP_EXTENSIONS.iter().map(|s| s.to_string()).collect()
            } else {
                extensions
            };
