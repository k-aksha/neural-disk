...
settings_broken_files_note = Resource-intensive scan. For best performance use NeuralDisk on desktop.
...
app_license = Frontend for NeuralDisk Core - GPL-3.0
...
same_music_fingerprint_warning = Calculating and comparing audio fingerprints is very resource-intensive and may take a long time. It is recommended to use NeuralDisk on a desktop system for this task.
