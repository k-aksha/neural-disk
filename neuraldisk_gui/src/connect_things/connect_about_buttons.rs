...
const REPOSITORY_SITE: &str = "https://github.com/k-aksha/neural-disk";
const INSTRUCTION_SITE: &str = "https://github.com/k-aksha/neural-disk/blob/master/instructions/Instruction.md";
const TRANSLATION_SITE: &str = "https://crwd.in/czkawka";
const KROKIET_SITE: &str = "https://github.com/k-aksha/neural-disk/tree/master/neuraldisk";
...
pub(crate) fn connect_about_buttons(gui_data: &GuiData) {
    ...
    button_krokiet.connect_clicked(move |_| {
        if let Err(e) = open::that(KROKIET_SITE) {
            error!("Failed to open NeuralDisk site: {KROKIET_SITE}, reason {e}");
        }
    });
