...
use neuraldisk_core::common::config_cache_path::{print_infos_and_warnings, set_config_cache_path};
use neuraldisk_core::common::consts::DEFAULT_THREAD_SIZE;
use neuraldisk_core::common::image::register_image_decoding_hooks;
use neuraldisk_core::common::logger::{filtering_messages, print_version_mode, setup_logger};
use neuraldisk_core::common::progress_data::ProgressData;
use neuraldisk_core::common::set_number_of_threads;
use neuraldisk_core::common::tool_data::{CommonData, DeleteMethod};
use neuraldisk_core::common::traits::{AllTraits, FixingItems, PrintResults, Search};
use neuraldisk_core::tools::bad_extensions::{BadExtensions, BadExtensionsFixParams, BadExtensionsParameters};
use neuraldisk_core::tools::bad_names::{BadNames, BadNamesParameters, NameFixerParams, NameIssues};
use neuraldisk_core::tools::big_file::{BigFile, BigFileParameters, SearchMode};
use neuraldisk_core::tools::broken_files::{BrokenFiles, BrokenFilesParameters, CheckedTypes};
use neuraldisk_core::tools::duplicate::{DuplicateFinder, DuplicateFinderParameters};
use neuraldisk_core::tools::empty_files::{EmptyFiles, EmptyFilesParameters};
use neuraldisk_core::tools::empty_folder::EmptyFolder;
use neuraldisk_core::tools::exif_remover::{ExifRemover, ExifRemoverParameters, ExifTagsFixerParams};
use neuraldisk_core::tools::invalid_symlinks::InvalidSymlinks;
use neuraldisk_core::tools::same_music::{SameMusic, SameMusicParameters};
use neuraldisk_core::tools::similar_images::{SimilarImages, SimilarImagesParameters};
use neuraldisk_core::tools::similar_videos::{SimilarVideos, SimilarVideosParameters};
use neuraldisk_core::tools::temporary::{Temporary, TemporaryParameters};
use neuraldisk_core::tools::video_optimizer::{
...
fn main() {
    ...
    let config_cache_path_set_result = set_config_cache_path("NeuralDisk", "NeuralDiskCli");
    setup_logger(true, "neuraldisk_cli", filtering_messages);
    print_version_mode("NeuralDisk cli");
