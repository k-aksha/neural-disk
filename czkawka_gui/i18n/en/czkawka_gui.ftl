...
krokiet_info_message =
        ...
        Most features from Czkawka GTK are available in NeuralDisk, usually in a simpler, faster, and more stable form. NeuralDisk also adds new features and improvements that were not possible in the GTK version.

        If you are still using Czkawka GTK, switching to NeuralDisk should be easy, since it has a similar interface, fewer dependencies, and better cross-platform support.
...
krokiet_promo_message =
        ...
        NeuralDisk includes everything people liked about Czkawka. It is completely free, open source, has a unique and simple UI (both praised and hated by many), introduces a lot of new features, uses fewer dependencies, and works far more reliably across different platforms.
