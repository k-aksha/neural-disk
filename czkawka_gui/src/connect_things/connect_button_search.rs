...
use neuraldisk_core::tools::temporary::Temporary;
    ...
    thread::Builder::new()
        ...
        .spawn(move || {
            let params = SimilarVideosParameters::new(
                ...
                neuraldisk_core::tools::similar_videos::DEFAULT_AUDIO_SIMILARITY_PERCENT,
                neuraldisk_core::tools::similar_videos::DEFAULT_AUDIO_MAXIMUM_DIFFERENCE,
                neuraldisk_core::tools::similar_videos::DEFAULT_AUDIO_LENGTH_RATIO,
                neuraldisk_core::tools::similar_videos::DEFAULT_AUDIO_MIN_DURATION_SECONDS,
            );
