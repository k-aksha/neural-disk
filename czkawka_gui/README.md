...
**Version 12.0 is the last released version of NeuralDisk Gui (GTK).** No new binaries will be provided. All users are encouraged to migrate to [NeuralDisk](../krokiet/README.md), the new Slint-based GUI.
...
This app is now branded NeuralDisk Gui. It was originally named Czkawka - here's the story of that name:
